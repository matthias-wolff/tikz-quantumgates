...
%% == \qgateCNC ===============================================================
\docCmd{qgateCNC[option]\{cwires\}\{x\}\{y\}\\\textbackslash qgateCNC*[option]\{cwires\}\{x\}\{y\}}{%
  Control qubit symbol of a controlled gate. Starred version draws inverse
  control.
}
