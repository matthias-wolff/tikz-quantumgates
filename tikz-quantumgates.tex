...
\\ 
  \centering\tikz{\qmeasM*{0}{0}{X}} &
  \centering\tikz{\qmeasM*[ibmqx]{0}{0}{X}} & 
  \texttt{\textbackslash qmeasM*[option]\{x\}\{y\}\{axis\}}
\\ 
...
%% == \qmeasM =================================================================
\docCmd{qmeasM[option]\{x\}\{y\}\\\textbackslash qmeasM*[option]\{x\}\{y\}\{axis\}}{%
  Measurement symbol.
}
